...
run:
	...
	docker run --dns 8.8.8.8 -h $(MAILHOSTNAME) --name $(IMAGENAME)_ins -p 3306:3306 -p 587:587 -p 143:143 -p 25:25 -p 80:80 -p 993:993 -p 995:995 -d $(MAINTAINERNAME)/$(IMAGENAME)
